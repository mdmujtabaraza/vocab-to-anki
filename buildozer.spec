...
requirements = python3,android,pyjnius,beautifulsoup4,brotlipy,cached-property,certifi,cffi,charset-normalizer,chevron,click,colorama,cryptography,decorator,docutils,frozendict,genanki,gTTS,ibm-watson,idna,Kivy,Kivy-Garden,kivymd,lxml,Pillow,pip,pycparser,Pygments,pyOpenSSL,PySocks,PyYAML,requests,setuptools,six,soupsieve,urllib3,user-agent,validators,wheel
...
#android.add_aars =
android.add_aars = ./src/android/lib/support-v4-24.1.1.aar
...
android.gradle_dependencies = "com.github.ankidroid:Anki-Android:api-v1.1.0"
