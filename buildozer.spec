...
requirements = python3==3.8.10,appdirs,attrs,Automat,bcrypt,brotlipy,cached-property,certifi,cffi,charset-normalizer,chevron,click,colorama,constantly,cryptography,cssselect,decorator,docutils,fake-useragent,Faker,filelock,frozendict,genanki,gTTS,hyperlink,idna,incremental,itemadapter,itemloaders,jmespath,Kivy,Kivy-Garden,kivymd,lxml,parsel,Pillow,pip,Protego,pyasn1,pyasn1-modules,pycparser,PyDispatcher,Pygments,pyOpenSSL,PySocks,python-dateutil,PyYAML,queuelib,requests,requests-file,Scrapy,scrapy-fake-useragent,service-identity,setuptools,six,tldextract,Twisted,typing_extensions,urllib3,validators,w3lib,wheel,win-inet-pton,zope.interface
